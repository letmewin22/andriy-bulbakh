...
export default function distort() {
  ...
  var hoverEffect = function(opts) {
    ...
    var image2 = opts.image1 || console.warn('second image missing');
    ...
    let neededImg = document.querySelector('.header__img');
    ...
    var animNew = document.querySelector('.header__img');
  ...
  // window.addEventListener('load', function(e) {
  //   Array.from(document.querySelectorAll('.grid__item-img-3')).forEach((el) => {
  //     const imgs = Array.from(el.querySelectorAll('img'));
  //     new hoverEffect({
  //       parent: el,
  //       intensity: el.dataset.intensity || undefined,
