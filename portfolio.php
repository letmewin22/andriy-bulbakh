...
<?php get_router('portfolio') ?>
  ...
  <div class="portfolio">
    <div class="container">
      ...
      <?php for ($i=0; $i < 6; $i++) { 
        ?>
          <li data-counter="<?php $i ?>" class="portfolio__li">
            <div class="portfolio__li-img" style="background-image:url('./img/architecture/slider/<?php $i+1 ?>.jpg')"></div>
          </li>
          <?php } ?>
      </ul>
    </div>
    <div class="portfolio__slider-pop-up">
      ...
      <div class="portfolio__slider">
        ...
        ?>
            ...
            style="background-image:url('./img/architecture/slider/<?php $i+1 ?>.jpg')"
            ></div>
            </div>
            <?php } ?>
        </div>
